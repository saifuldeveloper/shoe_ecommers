                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    <img class="admin-setting-img my-mw-100"
                                                                                        src="{{ $setting->favicon ? url('/storage/generalSettings/' . $setting->favicon) : url('/assets/images/placeholder.png') }}"
                                                                                        alt="No Image Found">
                                                                                </div>
                                                                    ...
                                                                    <div class="row justify-content-center">
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    <img class="admin-setting-img my-mw-100"
                                                                                        src="{{ $setting->loader ? url('/storage/generalSettings/' . $setting->loader) : url('/assets/images/placeholder.png') }}"
                                                                                        alt="No Image Found">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group position-relative ">
