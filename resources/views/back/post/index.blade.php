        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="right">
                        <a class="btn btn-primary  btn-sm" href="{{ route('back.post.create') }}"><i class="fas fa-plus"></i>
                            {{ __('Add') }}</a>
            ...
            <div class="card-body">
                ...
                <div class="gd-responsive-table">
                    <table class="table table-bordered table-striped" id="admin-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th> <input type="checkbox" data-target="blog-bulk-delete"
                        ...
                        <tbody>
                            @include('back.post.table', ['datas' => $datas, 'isSoftDelete' => false])
                        </tbody>

                    </table>
                </div>
                @if (count($softdeletes) > 0)
                    <div class="gd-responsive-table mt-4">
                        <h3 class="mb-0 bc-title pb-2"><b>{{ __('Deleted Blogs') }}</b></h3>
                        <table class="table table-bordered table-striped" id="admin-table" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>{{ __('Image') }}</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ __('You are going to delete this post. All contents related with this post will be lost.') }}
