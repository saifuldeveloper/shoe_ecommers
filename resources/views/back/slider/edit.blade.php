                                    ...
                                    @if ($slider->home_page != 'theme4')
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <img class="admin-img"
                                                    src="{{ $slider->mobile_photo ? url('/storage/slider/' . $slider->mobile_photo) : url('/assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                                <br>
                                                <span id="chenge_label2"
                                                    class="mt-1">{{ $slider->home_page == 'theme3' || $slider->home_page == 'theme4' ? __('Image Size Should Be 1864 x 714') : __('Image Size Should Be 1000 x 530') }}</span>
                                            ...
                                            <div class="form-group position-relative ">
                                                <label class="file">
                                                    <input type="file" accept="image/*" class="upload-photo"
                                                        name="mobile_photo" id="file" aria-label="File browser example">
                                                    <span class="file-custom text-left">{{ __('Upload Image...') }}</span>
                                                </label>
                                            </div>
                                        @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <span id="chenge_label2"
                                                    class="mt-1">{{ $slider->home_page == 'theme3' || $slider->home_page == 'theme4' ? __('Image Size Should Be 1920 x 750') : __('Image Size Should Be 1000 x 530') }}</span>
                                            </div>
