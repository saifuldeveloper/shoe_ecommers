    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <a class="btn btn-primary  btn-sm" href="{{route('back.color.create')}}"><i class="fas fa-plus"></i> {{ __('Add') }}</a>
                </div>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <a class="dropdown-item" href="{{ route('back.color.status',[$data->id,1,'status']) }}">{{ __('Enable') }}</a>
                                        <a class="dropdown-item" href="{{ route('back.color.status',[$data->id,0,'status']) }}">{{ __('Disable') }}</a>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="action-list">
                                        <a class="btn btn-secondary btn-sm "
                                            href="{{ route('back.color.edit',$data->id) }}">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger btn-sm " data-toggle="modal"
                                            data-target="#confirm-delete" href="javascript:;"
                                            data-href="{{ route('back.color.destroy',$data->id) }}">
