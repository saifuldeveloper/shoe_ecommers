        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                {{-- <div class="d-block text-right">
                    <a class="btn  btn-primary btn-sm py-1" data-href="{{ route('back.notifications.clear') }}"
                        href="javascript:;">
                ...
                @forelse(App\Models\Notification::orderby('id','desc')->get() as $notf)
                    @if ($notf->user_id != null)
                        <div class="d-flex align-items-center">
                            ...
                            <a class="dropdown-item d-flex align-items-center"
                                href="{{ route('back.user.show', $notf->user_id) }}">
                                <div class="mr-3">
                    ...
                    @if ($notf->order_id != null)
                        <div class="d-flex align-items-center">
                            ...
                            <a class="dropdown-item d-flex align-items-center"
                                href="{{ route('back.order.invoice', $notf->order_id) }}">
                                <div class="mr-3">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ __('You are going to delete this feature. All contents related with this feature will be lost.') }}
    ...
    $('.btn-primary').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                // Logic to remove the notification UI elements
