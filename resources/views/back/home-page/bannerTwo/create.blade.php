    ...
    <div class="card-body">
        <div class="container-fluid">
            ...
            <div class="tab-pane fade show active" id="v-pills-t9" role="tabpanel">
                ...
                <form class="admin-form" action="{{ route('back.second.home.page.store') }}" method="POST" enctype="multipart/form-data">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const input = document.getElementById("banner_second");
