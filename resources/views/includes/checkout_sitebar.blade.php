@php
    ...
    if (Auth::check() && Auth::user()->reward_point >= $minRedeemPoint) {
    ...
    <aside class="sidebar">
        ...
        @endforeach --}}
            @foreach ($cart as $key => $item)
                ...
                <div class="entry"
                    style="display: flex; justify-content: space-between; align-items: flex-start; padding: 10px 0; border-bottom: 1px solid #eee; margin-bottom: 10px;">

                    <div style="display: flex; align-items: flex-start;">
                        <div class="entry-thumb"
                            style="position: relative; margin-right: 15px; width: 60px; height: 60px; border-radius: 8px; overflow: hidden; flex-shrink: 0;">
                            <a href="#">
