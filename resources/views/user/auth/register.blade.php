                    ...
                    <form class="flex-c" action="{{ route('user.register.submit') }}" method="POST">
                        ...
                        <div class="input-box">
                            ...
                            <div class="flex-r input">
                                <input type="email" placeholder="{{ __('Enter your email') }}" value="{{ old('email') }}"
                                    name="email" class="btn-disable firstEmail">
                            </div>
                            @error('email')
                            ...
                            <div class="input-box">
                                ...
                                <div class="flex-r input">
                                    <input type="text" placeholder="{{ __('Enter your first name') }}"
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="flex-r input">
                                        <input type="text" placeholder="{{ __('Enter your last name') }}"
                                    ...
                                    <div class="input-box">
                                        ...
                                        <div class="flex-r input">
                                            <input type="text" placeholder="{{ __('Enter your phone number') }}"
                                                value="{{ old('phone') }}" name="phone" id="reg-phone" value="{{ old('phone') }}">
                                        </div>
                                        @error('phone')
                                            <p class="message-danger">{{ $message }}</p>
                                            @endif
                          ...
                          <div class="form-group">
                            ...
                            @endif
                                        ...
                                        <div class="input-box">
                                            ...
                                            <span class="pass_info">The password should be at least 6 characters long and must contain at
                                                least one upper case letter, one lower case letter, a number and a special character (!, @,
                                                #, $, %, &, *)</span>
                                            @error('password')
                                                <p class="message-danger">{{ $message }}</p>
                                                @endif
                                            ...
                                            <div class="input-box">
                                                ...
                                                @if ($reward?->status == 1)
                                                    ...
                                                    <div class="input-box" style="display: none">
                                                        ...
                                                        <div class="flex-r input show_hide_password">
                                                            <input type="text" name="reward_point" value="{{ $reward->reward_point ?? 0 }}"
                                                                readonly>
                                                ...
                                                @endif
{{-- 
                                                <input type="text" name="honeypot" id="honeypot" value="0" style="display:none;"> --}}
                                                ...
                                                <div class="check">
                                                    Already Have An Account ? <a class="log-small-text" href="{{ route('user.login') }}">Login
                                                        Now</a>
                                                </div>
                                                <!-- Submit -->
                                            ...
                                            @if ($setting->google_check == 1)
                                                ...
                                                <div class="social--login-btn">
                                                    <svg transform="scale(0.8)" xmlns="http://www.w3.org/2000/svg" height="90%" width="7%"
