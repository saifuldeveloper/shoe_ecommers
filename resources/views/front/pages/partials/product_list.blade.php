                    ...
                    <div class="ps-shoe__thumbnail">
                        ...
                        <a class="compare-button add-to-compare" href="javascript:void(0)" data-id="{{ $product->id }}"
                            ...
                            <svg class="icon" viewBox="0 0 1024 1024" version="1.1"
                                ...
                                <path
                                    d="M595.808 309.182c-6.039 0-12.078-2.062-16.938-6.481l-86.606-76.884c-8.395-7.513-13.257-18.265-13.257-29.605s4.861-22.095 13.257-29.605l86.606-77.034c10.458-9.426 26.659-8.395 35.939 2.062s8.395 26.659-2.062 35.939l-77.034 68.49 77.034 68.49c10.458 9.426 11.489 25.481 2.062 35.939-5.008 5.891-11.93 8.69-18.999 8.69z">
                                </path>
                                <path
                                    d="M447.194 822.045h-145.669c-74.676 0-135.36-60.684-135.36-135.36v-489.885c0-15.614 12.667-28.278 28.278-28.278s28.278 12.667 28.278 28.278v489.739c0 43.452 35.349 78.8 78.8 78.8h145.669c15.614 0 28.278 12.667 28.278 28.278 0 15.76-12.667 28.428-28.278 28.428z">
                                </path>
                                <path
                        ...
                        <div class="ps-shoe__variants">
                            <div class="text-center pb-10">
                                <p class="ps-shoe__categories pb-5">
                                    @php
                                        $sizes = collect($product->variants ?? [])
                                            ->pluck('size')
                                            ->unique('id')
                                            ->filter();
                                    @endphp
    ...
    <div class="modal-content">
        <div class="comparison-container">
            <div class="comparison-scroll-wrapper">
                ...
                <p id="compare-empty-message" class="text-center py-5 hidden">Add products to compare using the compare
                    icon on product hover.</p>
            </div>
        </div>
    </div>
</div>
